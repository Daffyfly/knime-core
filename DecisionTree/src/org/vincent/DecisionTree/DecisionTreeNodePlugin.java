 ...
 * @author 
 */
public class DecisionTreeNodePlugin extends Plugin {
    // The shared instance.
    private static DecisionTreeNodePlugin plugin;

    /**
     * The constructor.
     */
    public DecisionTreeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DecisionTreeNodePlugin getDefault() {
        return plugin;
    }
